...
$pageTitle = "Key Based PayPal Checker";
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <main class="main" id="main">
        <div class="container">
            <div class="page-header">
                <h1 class="page-title">Key Based PayPal Checker</h1>
            ...
            <div class="checker-layout">
                ...
                <div class="settings-section">
                    ...
                    <div class="input-group">
                        ...
                        <select id="apiMode">
                            <option value="sandbox">Sandbox Mode (Test - Recommended)</option>
                            <option value="live">Live Mode (Real Payments - Use Carefully)</option>
                        </select>
                    </div>
