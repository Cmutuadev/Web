...
// Default sites
$defaultSites = [
    'default' => 'https://razorpay.me/@azhimukham',
    'site1' => 'https://razorpay.me/@merchant1',
    'site2' => 'https://razorpay.me/@merchant2'
];
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .amount-selector { margin-bottom: 1rem; display: flex; align-items: center; gap: 1rem; }
        .amount-selector label { font-size: 0.7rem; }
        .amount-selector input { width: 100px; padding: 0.4rem; background: var(--bg); border: 1px solid var(--border); border-radius: 0.4rem; color: var(--text); }
...
<body data-theme="dark">
    ...
    <main class="main" id="main">
        <div class="container">
            <div class="page-header">
                ...
                <p class="page-subtitle">Automated CC checking via Razorpay payment links</p>
            </div>
            ...
            <div class="checker-card">
                <div class="site-selector">
                    ...
                    <div class="site-input" id="customSiteInput">
                        <input type="text" id="customSite" placeholder="https://razorpay.me/@merchant">
                    </div>
                </div>
                
                <div class="amount-selector">
                    <label>Amount (INR):</label>
                    <input type="number" id="amount" value="1" min="1" max="10000">
                </div>
    ...
    <script>
        ...
        function addResult(card, status, message, binInfo) {
            ...
            const icon = status === 'approved' ? 'fa-check-circle' : 
        ...
        async function processCards() {
            ...
            let siteUrl = 'https://razorpay.me/@azhimukham';
            if (siteMode === 'custom' && customSite) siteUrl = customSite;
            ...
            for (let i = 0; i < cards.length && !shouldStop; i++) {
                ...
                try {
                    ...
                    const response = await fetch('/gate/razorpay.php', { method: 'POST', body: formData });
                    ...
                    if (output.indexOf('APPROVED') !== -1) { 
                        ...
                        processed++;
                    } else if (output.indexOf('3DS') !== -1) { 
                        status = 'threeds'; 
                        message = '⚠ 3D Secure required';
                    } else if (output.indexOf('Invalid CVV') !== -1) { 
                        status = 'invalid_cvv'; 
                        message = '✗ Invalid security code';
                    } else if (output.indexOf('expired') !== -1) { 
                        status = 'expired'; 
                        message = '✗ Card expired';
                    } else if (output.indexOf('Insufficient') !== -1) { 
                        status = 'declined'; 
                        message = '✗ Insufficient funds';
                    } else if (output.indexOf('incorrect') !== -1) { 
                        status = 'declined'; 
        ...
        function downloadResults(type) {
            ...
            if (text) {
                ...
                a.href = url;
                a.download = `razorpay-${type}-${new Date().toISOString().slice(0,19)}.txt`;
                a.click();
