...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        :root { --bg: #0a0a0f; --card: #111114; --border: #1e1e24; --text: #ffffff; --text-muted: #6b6b76; --primary: #8b5cf6; }
    ...
    <main class="main">
        <div class="container">
            <div class="page-header">
                ...
                <p class="page-subtitle">Coming soon - Under development</p>
            </div>
            <div class="card">
                ...
                <a href="/index.php?page=home" class="btn" style="margin-top: 1rem; display: inline-block;">Return to Dashboard</a>
            </div>
        </div>
    </main>
    <script>
