...
curl_setopt($ch, CURLOPT_COOKIEJAR, '/tmp/cookies_paypal2.txt');
...
// Step 2: Register donation with $2 amount
$ch = curl_init();
...
curl_setopt($ch, CURLOPT_COOKIEFILE, '/tmp/cookies_paypal2.txt');
curl_setopt($ch, CURLOPT_COOKIEJAR, '/tmp/cookies_paypal2.txt');
...
@unlink('/tmp/cookies_paypal2.txt');
...
if (strpos($combinedUpper, 'APPROVESTATE":"APPROVED') !== false) {
    echo "APPROVED: Payment charged successfully (\$2)";
